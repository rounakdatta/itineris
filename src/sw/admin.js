...
installSw(self, { app: "admin", version: __VERSION__, precache: __PRECACHE__, keep: __KEEP__, indexUrl: "/admin/index.html", scope: "/admin/", apiPaths: ["/admin/api/library", "/admin/api/me"] });
